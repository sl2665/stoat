...
browser.setup(genelist="bed/gencode.v26.uniq.bed",
	      ...
	      label.y = 1, description = "PRO-seq", gene.line = 2)
browser.setpos("chr1", 1613000, 1632000)
browser.read()
ymax = c(200,200)
ymax = browser.print(filename="pdf/fig4e1.pdf", nbin=250, width=6, height = 2, ymax=ymax)
print(ymax)
...
browser.read()
ymax = c(40,40)
ymax = browser.print(filename="pdf/fig4e2.pdf", nbin=250, width=6, height = 1.8, ymax=ymax)
print(ymax)
browser.new()
browser.setup(genelist="bed/RNAseq.cufflinks.bed",
	      bedgraph = bglist[5:6],
	      col = color[5:6], heights = c(2,2), hlines = 4,
	      label.y = 2, description = "RNA-seq", gene.line = 10,
	      gene.col = color[5:6])
browser.setpos("chr1", 1613000, 1632000)
browser.read()
ymax = c(30,30)
ymax = browser.print(filename="pdf/fig4e3.pdf", nbin=250, width=6, height = 2.6, ymax=ymax)
print(ymax)
