...
```
Use Hidden Markov Model to detect RNAP inhibition waves for elongation speed analysis (Jonkers et al, 2014, eLife). See doc/additional_document.pdf for further details.
